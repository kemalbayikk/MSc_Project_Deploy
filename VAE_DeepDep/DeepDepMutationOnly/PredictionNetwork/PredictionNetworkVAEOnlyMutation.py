...
if __name__ == '__main__':
    ...
    # Create the VAE_DeepDep model using the pretrained VAE models
    model = MutFingerprint_VAE_DeepDep(premodel_mut, premodel_exp, premodel_cna, premodel_meth, premodel_fprint, 100)
