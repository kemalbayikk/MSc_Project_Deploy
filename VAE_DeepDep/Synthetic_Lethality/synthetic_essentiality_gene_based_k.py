...
if __name__ == '__main__':
    ...
    for gene in genes:
        ...
        print(f"\n\nPrediction completed in %.1f mins.\nResults saved in PytorchStaticSplits/SyntheticEssentiality/{gene}_only_mut_predictions_TCGA.csv\n" % ((time.time()-t)/60))
        print(f"Highest SE scores saved in PytorchStaticSplits/SyntheticEssentiality/Highest_SE_Scores_{gene}_TCGA.csv\n")
