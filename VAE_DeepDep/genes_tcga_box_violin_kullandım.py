...
# # Veriyi yükle
data_path = 'PytorchStaticSplits/DeepDepVAE/Analysis/tcga_predicted_data.txt'  # Verinizi yükledikten sonra dosya yolunu güncelleyin
...
top_30_genes_txt = txt_average_impact.nsmallest(20, 'Dependency Score')['CRISPR_GENE']
